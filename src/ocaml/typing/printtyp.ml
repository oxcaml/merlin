...
let tree_of_path = tree_of_path
let tree_of_type_scheme = tree_of_type_scheme
let tree_of_type_declaration = tree_of_type_declaration
let tree_of_modtype = tree_of_modtype
let tree_of_modtype_declaration = tree_of_modtype_declaration
let tree_of_modalities = tree_of_modalities

let shorten_type_path env p =
  wrap_printing_env env (fun () -> p)

let shorten_module_type_path env p =
  wrap_printing_env env (fun () -> p)

let shorten_module_path = shorten_module_type_path
let shorten_class_type_path = shorten_type_path

let type_declaration_for_merlin ~print_non_value_inferred_jkind:_ id ppf decl =
  type_declaration id ppf decl

let type_scheme_for_merlin ~print_non_value_jkind_on_type_variables:_ ppf ty =
  type_scheme ppf ty
